 ...
 * @author sparsh
 */
public class addvehicle extends javax.swing.JInternalFrame implements myvariables {
    ...
    private void initComponents() {
        ...
        setMaximizable(true);
        setResizable(true);
        setTitle("Add New Vehicle Details");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try
        {
            ...
            try
            {
                String query="insert into vehicletable values(?,?,?,?,?,?,?,?,?)";
                ...
                {
                    mystatement.setString(4, "Low Weight");
                }
                else
                        {
                            mystatement.setString(4, "Heavy Weight");
                        }
                
                 if(jRadioButton3.isSelected())
                {
                    mystatement.setString(5, "Two");
                }
                 else if(jRadioButton4.isSelected())
                   {
                     mystatement.setString(5, "Three");
                   }
                 else
                 {
                     mystatement.setString(5, "Four");
                 }
