 ...
 * @author sparsh
 */
public class deleteemployeeacc extends javax.swing.JInternalFrame {

    /**
     * Creates new form createemployee
     */
    public deleteemployeeacc() {
        initComponents();
    }
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        try
        { 
            int a= JOptionPane.showConfirmDialog(rootPane, "Do you really want to Delete Employee account? Username:"+jTextField1.getText(), "Confirm", JOptionPane.YES_NO_OPTION);
             if(a==JOptionPane.YES_OPTION)
             {
            String query="delete from employeelogin where username=? and password=?";
            PreparedStatement mystatement=myconnection.prepareStatement(query);
            mystatement.setString(1, jTextField1.getText());
            mystatement.setString(2, jPasswordField1.getText());
            if(mystatement.executeUpdate()>0)
            {
                JOptionPane.showMessageDialog(rootPane, "Employee Account Deleted Successfully");
                this.dispose();
            }
            else
            {
